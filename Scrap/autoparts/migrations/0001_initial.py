    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_direction', models.CharField(blank=True, choices=[('Right', 'يمين'), ('Left', 'يسار')], max_length=64, null=True)),
                ...
                ('image', models.ImageField(blank=True, default='products_images/default.svg', upload_to='products_images/')),
